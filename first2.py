...
group_list = [
    '@talamarkettt', '@tays56', '@teampayamanmarket', '@teiemart', '@telehub2', '@telemarketph', '@telemartph',
    '@telepromobuyselltrade', '@TeleStoreOGChat', '@teleworldmarket', '@terramarket', '@tgmegamart',
    '@tgonlinemarket', '@theblackmarket', '@thebloommartph', '@theboysmarketplace', '@thecloutmarket',
    '@TheDMarket', '@theelfantasma', '@TheFinalMarket', '@TheGalaxyMarket', '@Thejunglemarket', '@thekentmart',
    '@themobilemarket', '@thenightmarket', '@thepeachymart', '@ThePlugMarket', '@thepugmarket', '@theredmarket',
    '@ThrillsMarket', '@titanmarket', '@tjsmarketplacepublic', '@TMBusinessSocialMediaSellGroup',
    '@tmbusinesssocialmediasellgroup', '@TMGMarket', '@topmarts', '@trufflesfs', '@TrustedMarket', '@twiceujjangmarket',
    '@umbrellamarket', '@undergroundmarket1620', '@unholymarket', '@universalmarkettt', '@urbanmarketph',
    '@versacemarket', '@viralsmarket', '@virgomarketplace', '@vntrmarket', '@w0rldmarket', '@Waitermarket',
    '@wasgmarket', '@wbmarketingmarket', '@windsales', '@wobblezmarket', '@wolf_market20', '@wysmarketingchat',
